...
class ProgressBar extends ExtensionsController {
	...
	public function progressbar() {
		vc_map( array(
			"name"        => __( "Progress Bar", 'prime_vc' ),
			"base"        => "pr_progressbar",
			"icon"        => "pev-progressbar",
			...
			"params"      => array(
				...
				array(
					'type'        => 'prime_slider',
					'heading'     => __( 'Bar percentage', 'prime_vc' ),
					'param_name'  => 'bar_percentage',
					'tooltip'     => __( 'Choose Bar Parcentage, Default is 95%.', 'prime_vc' ),
					'min'         => 1,
					'max'         => 100,
					'step'        => 1,
					'value'       => 95,
				...
				array(
					"type"        => "colorpicker",
					"class"       => "",
					"heading"     => __( "Bar Background color", "prime_vc" ),
				...
				array(
					...
					"heading"     => __( "Margin Top", 'prime_vc' ),
				...
				array(
					...
					/*"holder" => "div",*/
					"edit_field_class" => "vc_col-xs-6 vc_column",
					"heading"     => __( "Margin Bottom", 'prime_vc' ),
